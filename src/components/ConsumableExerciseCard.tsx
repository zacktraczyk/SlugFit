        ...
        <><ScrollView className='flex-1 w-full h-full p-4 bg-white '>
                ...
                <View className ='flex-row'>
                    ...
                    <TouchableOpacity accessibilityRole="button"
                        ...
                        className="bg-white">        
                        {pastExericises && closePastPerformance &&(<View className='mt-2 bg-gray-300 rounded-lg' ><Text className="m-1 mt-1 ml-2 text-sm font-bold text-center bg-gray-300 ">{closePastPerformance? formatDateTime(pastExericises[index].created_at):formatDateTime(selectedExercise.created_at)}</Text></View>)}
